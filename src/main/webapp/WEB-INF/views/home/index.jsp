  ...
  <div class="row">
    ...
    <div class="col-9">
      ...
      <nav aria-label="Page navigation example">
        <ul class="pagination">
          <li class="page-item"><a class="page-link" href="/?page=0">&laquo;</a></li>
          <li class="page-item"><a class="page-link" href="/?page=${page.number}">&lsaquo;</a></li>
          <li class="page-item"><a class="page-link" href="/?page=${page.number+1}">&rsaquo;</a></li>
          <li class="page-item"><a class="page-link" href="/?page=${page.totalPages-1}">&raquo;</a></li>
        </ul>
